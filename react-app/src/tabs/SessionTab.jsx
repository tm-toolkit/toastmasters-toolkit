...
export default function SessionTab({ currentRole, roster, history, setHistory, onAhCount, onTimerCount, onGoToOtherTools }) {
  return (
    <div>
      ...
      <div style={{ display: currentRole === 'timer' ? '' : 'none' }}>
        <TimerPanel roster={roster} history={history} setHistory={setHistory} onCountChange={onTimerCount} onGoToOtherTools={onGoToOtherTools} />
      </div>
    </div>
  );
}
